...
public class Runner {
	...
	public static void main(String[] args) {		
		...
		Result result = new EvoSQL("jdbc:hsqldb:file:testdb", "testdb", "SA", "", false).execute("SELECT * FROM "
	...
	private static void createFakeDatabase() {
		...
		theDatabase.execute("CREATE TABLE PRODUCTS ( PRODUCT VARCHAR(500) NULL, PRICE INT NULL)");
